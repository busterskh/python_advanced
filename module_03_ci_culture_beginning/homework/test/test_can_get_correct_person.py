...
class TestPerson(unittest.TestCase):
    ...
    def test_can_get_age(self):
        self.assertTrue(self.bob.get_age() == 2022 - 1987)

    def test_can_get_name(self):
        self.assertTrue(self.bob.get_name() == self.name)

    def test_can_get_address(self):
        self.assertTrue(self.bob.get_address() == self.address)

    def test_can_get_year_of_birth(self):
        self.assertTrue(self.bob.get_year_of_birth() == self.year_of_birth)

    def test_can_set_name(self):
        new_name = 'Not Bob'
        self.bob.set_name(name=new_name)
        self.assertTrue(self.bob.get_name() == new_name)

    def test_can_set_address(self):
        new_address = '1123, North avenue'
        self.bob.set_address(address=new_address)
        self.assertTrue(self.bob.get_address() == new_address)

    def test_can_set_year_of_birth(self):
        new_yob = 1999
        self.bob.set_yob(year_of_birth=new_yob)
        self.assertTrue(self.bob.get_year_of_birth() == new_yob)
